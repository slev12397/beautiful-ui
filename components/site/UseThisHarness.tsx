...
2. Install the deps it uses: tailwindcss v4, plus @central-icons-react for the
   sidebar icons — that's a commercial set, so set CENTRAL_LICENSE_KEY (from
   centralicons.com) or swap those icons for your own. The sounds (cuelume) and
   dev dial tuning (dialkit) are optional — drop them if you don't want them,
   and remove the posthog analytics calls.
...
const glyph = {
  ...
  spark: <path d="M12 3l1.7 5.1a2 2 0 0 0 1.2 1.2L20 11l-5.1 1.7a2 2 0 0 0-1.2 1.2L12 19l-1.7-5.1a2 2 0 0 0-1.2-1.2L4 11l5.1-1.7a2 2 0 0 0 1.2-1.2z" />,
};
    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between gap-3 px-5 pt-5 pb-4">
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <span className="flex size-6 items-center justify-center rounded-[7px] bg-accent-tint text-accent">
                <Icon path={glyph.spark} size={14} sw={1.6} />
              </span>
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 pb-5">
          <div className="mb-2 flex items-center gap-1.5 text-[11.5px] font-medium tracking-wide text-ink-3 uppercase">
            <span className="flex size-4 items-center justify-center rounded-full bg-ink text-[10px] font-semibold text-canvas">1</span>
          ...
          >
            ...
            {prompt.copied ? "Copied — paste it into your agent" : "Copy instructions"}
          </button>

          {/* secondary — clone it yourself */}
          <div className="mt-5 mb-2 flex items-center gap-1.5 text-[11.5px] font-medium tracking-wide text-ink-3 uppercase">
            <span className="flex size-4 items-center justify-center rounded-full bg-hover-2 text-[10px] font-semibold text-ink-2">2</span>
